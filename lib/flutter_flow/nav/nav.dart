        ...
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              name: 'TimerGame',
              path: 'timerGame',
              builder: (context, params) => TimerGameWidget(),
            ),
            FFRoute(
              name: 'ParthivTest',
              path: 'parthivTest',
            ...
            FFRoute(
              name: 'VisualSearch',
              path: 'visualSearch',
              builder: (context, params) => VisualSearchWidget(),
            ),
            FFRoute(
            ...
            FFRoute(
              name: 'FocusVideo',
              path: 'focusVideo',
              builder: (context, params) => FocusVideoWidget(),
            ),
            FFRoute(
              name: 'nBack',
              path: 'nBack',
              builder: (context, params) => NBackWidget(),
            ),
            FFRoute(
              name: 'showShapesNBack',
              path: 'showShapesNBack',
              builder: (context, params) => ShowShapesNBackWidget(),
            ),
            FFRoute(
              name: 'sortShapes',
              path: 'sortShapes',
              builder: (context, params) => SortShapesWidget(),
            ),
            FFRoute(
              name: 'multipleChoice1',
              path: 'multipleChoice1',
              builder: (context, params) => MultipleChoice1Widget(),
            ),
            FFRoute(
              name: 'multipleChoice2',
              path: 'multipleChoice2',
              builder: (context, params) => MultipleChoice2Widget(),
            ),
            FFRoute(
              name: 'multipleChoice3',
              path: 'multipleChoice3',
              builder: (context, params) => MultipleChoice3Widget(),
            ),
            FFRoute(
              name: 'Dash',
              path: 'dash',
            ...
            FFRoute(
              ...
              path: 'chatbotCopy',
              builder: (context, params) => params.isEmpty
                  ? NavBarPage(initialPage: 'ChatbotCopy')
                  : ChatbotCopyWidget(
                      t2: params.getParam(
                        't2',
                        ParamType.JSON,
            ...
            FFRoute(
              name: 'Pom',
              path: 'pom',
              builder: (context, params) => PomWidget(),
            ),
            FFRoute(
              name: 'study',
              path: 'study',
