...
class _StudyWidgetState extends State<StudyWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'study'});
          ...
          children: [
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'Choose a sound to enhance your focus',
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: Slider(
                                    ...
                                    min: 0.0,
                                    max: 100.0,
                                    value: _model.sliderValue4 ??= 50.0,
                                    onChanged: (newValue) {
                                      newValue = double.parse(
                                          newValue.toStringAsFixed(4));
                                      safeSetState(
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: Slider(
                                    ...
                                    min: 0.0,
                                    max: 100.0,
                                    value: _model.sliderValue5 ??= 50.0,
                                    onChanged: (newValue) {
                                      newValue = double.parse(
                                          newValue.toStringAsFixed(4));
                                      safeSetState(
            ...
            Padding(
              ...
              child: FlutterFlowIconButton(
                ...
                onPressed: () async {
                  logFirebaseEvent('STUDY_PAGE_arrow_back_ICN_ON_TAP');
