...
import 'schema/visual_search_record.dart';
...
export 'schema/visual_search_record.dart';
...
/// Functions to query VisualSearchRecords (as a Stream and as a Future).
Future<int> queryVisualSearchRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      VisualSearchRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<VisualSearchRecord>> queryVisualSearchRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      VisualSearchRecord.collection,
      VisualSearchRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<VisualSearchRecord>> queryVisualSearchRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
