...
class _InfoWidgetState extends State<InfoWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('INFO_PAGE_Info_ON_INIT_STATE');
      logFirebaseEvent('Info_haptic_feedback');
                            ...
                            child: Container(
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                      'We will track your attention span over time',
                                      style: FlutterFlowTheme.of(context)
                                          .titleMedium
                                          .override(
                                            fontFamily: 'Inter',
                                    ...
                                    Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                          0.0, 6.0, 0.0, 0.0),
                                      child: Text(
                                        'Take your Diagnostic by clicking on this box.',
                                        style: FlutterFlowTheme.of(context)
                                            .labelLarge
                                            .override(
                                              fontFamily: 'Inter',
                          ...
                          child: Column(
                            ...
                            children: [
                              InkWell(
                                ...
                                onTap: () async {
                                  logFirebaseEvent(
                                      'INFO_PAGE_EditProfileTile_ON_TAP');
                                  logFirebaseEvent(
                              ...
                              InkWell(
                                ...
                                onTap: () async {
                                  logFirebaseEvent(
                                      'INFO_PAGE_ContactUsTile_ON_TAP');
                                  logFirebaseEvent('ContactUsTile_send_email');
                                  await launchUrl(Uri(
                                    scheme: 'mailto',
                                    path: 'saurish.st@gmail.com',
                                  ));
                                },
                                child: Column(
                                  mainAxisSize: MainAxisSize.max,
