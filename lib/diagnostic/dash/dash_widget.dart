...
class DashWidget extends StatefulWidget {
  /// Shows the user their progress and their score.
                                ...
                                children: [
                                  Expanded(
                                    child: InkWell(
                                      ...
                                      onTap: () async {
                                        logFirebaseEvent(
                                            'DASH_PAGE_Container_2eiaukwr_ON_TAP');
                                      },
                                      child: Container(
                                        width: 115.0,
                                        height: 100.0,
                      ...
                      children: [
                            ...
                            children: [
                              Padding(
                                ...
                                child: FlutterFlowIconButton(
                                  ...
                                  onPressed: () async {
                                    logFirebaseEvent(
                                        'DASH_PAGE_arrow_back_ICN_ON_TAP');
                                                              ...
                                                              padding:
                                                                  EdgeInsetsDirectional
                                                                      .fromSTEB(
                                                                          ...
                                                                          0.0),
                                                              child: Text(
                                                                'You did great! Continue Inproving!',
                                                                style: FlutterFlowTheme.of(
                                                                        context)
                                                                    .labelMedium
                                                                    .override(
                                          ...
                                          Padding(
                                            padding:
                                                EdgeInsetsDirectional.fromSTEB(
                                                    24.0, 4.0, 24.0, 8.0),
                                            child: Text(
                                              'You can now improve your skills with a daily 10 minutes of exersize either in the morning or evening',
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .labelSmall
                                                      .override(
                        ...
                        Container(
                          ...
                          child: FlutterFlowLineChart(
                            data: [
                              FFLineChartData(
                                xData: FFAppState().vsCorrectAnswer,
                                yData: FFAppState().vsCorrectAnswer,
